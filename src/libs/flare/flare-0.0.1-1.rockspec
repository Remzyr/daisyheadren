...
build = {
    ...
    modules = {
        ...
        ["flare.core.gamesubstate"] = "core/gamesubstate.lua",
        ["flare.core.group"] = "core/group.lua",
        ["flare.core.object"] = "core/object.lua",
        ["flare.core.signal"] = "core/signal.lua",
        ["flare.core.timer"] = "core/timer.lua",
        ["flare.graphics.animatedsprite"] = "graphics/animatedsprite.lua",
        ...
        ["flare.graphics.trail"] = "graphics/trail.lua",
        ["flare.graphics.video"] = "graphics/video.lua",
        ["flare.audio.sound"] = "audio/sound.lua",
        ["flare.input.inputaction"] = "input/inputaction.lua",
        ...
        ["flare.utils.color"] = "utils/color.lua",
        ["flare.utils.locale"] = "utils/locale.lua",
        ["flare.utils.paths"] = "utils/paths.lua",
        ["flare.utils.pool"] = "utils/pool.lua",
